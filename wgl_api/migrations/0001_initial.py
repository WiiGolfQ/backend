    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('require_livestreams', models.BooleanField(default=False)),
                ('minimum_livestreamers', models.IntegerField(blank=True, default=None, null=True)),
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wgl_api.game')),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            model_name='game',
            name='group',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='wgl_api.group'),
        ),
        migrations.CreateModel(
            name='Match',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queues_for', models.ManyToManyField(blank=True, related_name='players_in_queue', to='wgl_api.category')),
