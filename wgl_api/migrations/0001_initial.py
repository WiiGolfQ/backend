# Generated by Django 5.0.1 on 2024-08-10 21:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currently_playing_match', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='wgl_api.match')),
                ('elos', models.ManyToManyField(through='wgl_api.Elo', to='wgl_api.category')),
